...
impl FloatArgsExtractor {
    ...
    pub fn extract_bool_value(
        ...
        self.args_extractor
            .extract_bool_value(self.args_extractor.extract_term(constraint, index), solution)
    }
    ...
    pub fn extract_int_value(
        ...
        self.args_extractor
            .extract_int_value(self.args_extractor.extract_term(constraint, index), solution)
    }
