...
use flatzinc_serde::{Array, Call, Identifier, Argument};
...
impl IntArgsExtractor {
    pub fn new() -> Self {
        Self { args_extractor: ArgsExtractor::new() }
    }
    ...
    pub fn extract_var_values_lin_expr(&self, index: usize, constraint: &Call, arrays: &HashMap<Identifier, Array>) -> Vec<Identifier> {
        self.args_extractor.extract_var_values_lin_expr(index, constraint, arrays)
    }
    ...
    pub fn extract_int_element_array(
        ...
        self.args_extractor.extract_int_array_element(constraint, arrays, solution)
    }
