...
use crate::evaluator::sub_types::bool_invariant_evaluator::BoolInvariantEvaluator;
use crate::evaluator::sub_types::float_invariant_evaluator::FloatInvariantEvaluator;
use crate::evaluator::sub_types::int_invariant_evaluator::IntInvariantEvaluator;
use crate::evaluator::sub_types::set_invariant_evaluator::SetInvariantEvaluator;
...
impl Evaluator {
    pub fn new(path: &Path, fzn: FlatZinc, option: Option<&str>) -> Self {
        ...
        let float_invariant_evaluator =
            FloatInvariantEvaluator::new(arrays_hashmap.clone(), verbose);
    ...
    pub fn evaluate_constraints(
        ...
        constraints_to_eval: &[CallWithDefines],
    ) -> (Option<f64>, f64) {
        let defined_variables: Vec<String> = solution_provider
            .defined_vars_map()
            .iter()
            .cloned()
            .collect();
    ...
    fn evaluate_int_predicate(
        ...
        match constraint.call.id.as_str() {
            ...
            "int_eq_reif" => self
                .int_invariant_evaluator
                .int_eq_reif(&constraint, solution),
            "int_le" => self.int_invariant_evaluator.int_le(&constraint, solution),
            "int_le_reif" => self
                .int_invariant_evaluator
                .int_le_reif(&constraint, solution),
            "int_lin_eq" => self
                .int_invariant_evaluator
                .int_lin_eq(&constraint, solution),
            "int_lin_eq_reif" => self
                .int_invariant_evaluator
                .int_lin_eq_reif(&constraint, solution),
            "int_lin_le" => self
                .int_invariant_evaluator
                .int_lin_le(&constraint, solution),
            "int_lin_le_reif" => self
                .int_invariant_evaluator
                .int_lin_le_reif(&constraint, solution),
            "int_lin_ne" => self
                .int_invariant_evaluator
                .int_lin_ne(&constraint, solution),
            "int_lin_ne_reif" => self
                .int_invariant_evaluator
                .int_lin_ne_reif(&constraint, solution),
            "int_lt" => self.int_invariant_evaluator.int_lt(&constraint, solution),
            "int_lt_reif" => self
                .int_invariant_evaluator
                .int_lt_reif(&constraint, solution),
    ...
    fn evaluate_float_predicate(
        ...
        match constraint.call.id.as_str() {
            ...
            "float_abs" => self
                .float_invariant_evaluator
                .float_abs(&constraint, solution),
            "float_acos" => self
                .float_invariant_evaluator
                .float_acos(&constraint, solution),
            "float_acosh" => self
                .float_invariant_evaluator
                .float_acosh(&constraint, solution),
            "float_asin" => self
                .float_invariant_evaluator
                .float_asin(&constraint, solution),
            "float_asinh" => self
                .float_invariant_evaluator
                .float_asinh(&constraint, solution),
            "float_atan" => self
                .float_invariant_evaluator
                .float_atan(&constraint, solution),
            "float_atanh" => self
                .float_invariant_evaluator
                .float_atanh(&constraint, solution),
            "float_cos" => self
                .float_invariant_evaluator
                .float_cos(&constraint, solution),
            "float_cosh" => self
                .float_invariant_evaluator
                .float_cosh(&constraint, solution),
            "float_div" => self
                .float_invariant_evaluator
                .float_div(&constraint, solution),
            "float_eq" => self
                .float_invariant_evaluator
                .float_eq(&constraint, solution),
            "float_eq_reif" => self
                .float_invariant_evaluator
                .float_eq_reif(&constraint, solution),
            "float_exp" => self
                .float_invariant_evaluator
                .float_exp(&constraint, solution),
            "float_le" => self
                .float_invariant_evaluator
                .float_le(&constraint, solution),
            "float_le_reif" => self
                .float_invariant_evaluator
                .float_le_reif(&constraint, solution),
            "float_lin_eq" => self
                .float_invariant_evaluator
                .float_lin_eq(&constraint, solution),
            "float_lin_eq_reif" => self
                .float_invariant_evaluator
                .float_lin_eq_reif(&constraint, solution),
            "float_lin_le" => self
                .float_invariant_evaluator
                .float_lin_le(&constraint, solution),
            "float_lin_le_reif" => self
                .float_invariant_evaluator
                .float_lin_le_reif(&constraint, solution),
            "float_lin_lt" => self
                .float_invariant_evaluator
                .float_lin_lt(&constraint, solution),
            "float_lin_lt_reif" => self
                .float_invariant_evaluator
                .float_lin_lt_reif(&constraint, solution),
            "float_lin_ne" => self
                .float_invariant_evaluator
                .float_lin_ne(&constraint, solution),
            "float_lin_ne_reif" => self
                .float_invariant_evaluator
                .float_lin_ne_reif(&constraint, solution),
            "float_ln" => self
                .float_invariant_evaluator
                .float_ln(&constraint, solution),
            "float_log10" => self
                .float_invariant_evaluator
                .float_log10(&constraint, solution),
            "float_log2" => self
                .float_invariant_evaluator
                .float_log2(&constraint, solution),
            "float_lt" => self
                .float_invariant_evaluator
                .float_lt(&constraint, solution),
            "float_lt_reif" => self
                .float_invariant_evaluator
                .float_lt_reif(&constraint, solution),
            "float_max" => self
                .float_invariant_evaluator
                .float_max(&constraint, solution),
            "float_min" => self
                .float_invariant_evaluator
                .float_min(&constraint, solution),
            "float_ne" => self
                .float_invariant_evaluator
                .float_ne(&constraint, solution),
            "float_ne_reif" => self
                .float_invariant_evaluator
                .float_ne_reif(&constraint, solution),
            "float_plus" => self
                .float_invariant_evaluator
                .float_plus(&constraint, solution),
            "float_pow" => self
                .float_invariant_evaluator
                .float_pow(&constraint, solution),
            "float_sin" => self
                .float_invariant_evaluator
                .float_sin(&constraint, solution),
            "float_sinh" => self
                .float_invariant_evaluator
                .float_sinh(&constraint, solution),
            "float_sqrt" => self
                .float_invariant_evaluator
                .float_sqrt(&constraint, solution),
            "float_tan" => self
                .float_invariant_evaluator
                .float_tan(&constraint, solution),
            "float_tanh" => self
                .float_invariant_evaluator
                .float_tanh(&constraint, solution),
            "float_times" => self
                .float_invariant_evaluator
                .float_times(&constraint, solution),
            "int2float" => self
                .float_invariant_evaluator
                .int2float(&constraint, solution),
            other => panic!("Missing predicate: {}", other),
        }
    }
    ...
    fn evaluate_bool_predicate(
        ...
        match constraint.call.id.as_str() {
            "array_bool_and" => self
                .bool_invariant_evaluator
                .array_bool_and(&constraint, solution),
            "array_bool_element" => self
                .bool_invariant_evaluator
                .array_bool_element(&constraint, solution),
            "array_bool_xor" => self
                .bool_invariant_evaluator
                .array_bool_xor(&constraint, solution),
            "array_var_bool_element" => self
                .bool_invariant_evaluator
                .array_bool_element(&constraint, solution),
            "bool_and" => self
                .bool_invariant_evaluator
                .bool_and(&constraint, solution),
            "bool_clause" => self
                .bool_invariant_evaluator
                .bool_clause(&constraint, solution),
            "bool_eq" => self.bool_invariant_evaluator.bool_eq(&constraint, solution),
            "bool_eq_reif" => self
                .bool_invariant_evaluator
                .bool_eq_reif(&constraint, solution),
            "bool_le" => self.bool_invariant_evaluator.bool_le(&constraint, solution),
            "bool_le_reif" => self
                .bool_invariant_evaluator
                .bool_le_reif(&constraint, solution),
            "bool_lin_eq" => self
                .bool_invariant_evaluator
                .bool_lin_eq(&constraint, solution),
            "bool_lin_le" => self
                .bool_invariant_evaluator
                .bool_lin_le(&constraint, solution),
            "bool_lt" => self.bool_invariant_evaluator.bool_lt(&constraint, solution),
            "bool_lt_reif" => self
                .bool_invariant_evaluator
                .bool_lt_reif(&constraint, solution),
            "bool_not" => self
                .bool_invariant_evaluator
                .bool_not(&constraint, solution),
            "bool_or" => self.bool_invariant_evaluator.bool_or(&constraint, solution),
            "bool_xor" => self
                .bool_invariant_evaluator
                .bool_xor(&constraint, solution),
            "bool2int" => self
                .bool_invariant_evaluator
                .bool2int(&constraint, solution),
            other => panic!("Missing predicate: {}", other),
        }
    }
    ...
    fn evaluate_set_predicate(
        ...
        match constraint.call.id.as_str() {
            ...
            "set_eq_reif" => self
                .set_invariant_evaluator
                .set_eq_reif(&constraint, solution),
            "set_in" => self.set_invariant_evaluator.set_in(&constraint, solution),
            "set_in_reif" => self
                .set_invariant_evaluator
                .set_in_reif(&constraint, solution),
            "set_intersect" => self
                .set_invariant_evaluator
                .set_intersect(&constraint, solution),
            "set_le" => self.set_invariant_evaluator.set_le(&constraint, solution),
            "set_le_reif" => self
                .set_invariant_evaluator
                .set_le_reif(&constraint, solution),
            "set_lt" => self.set_invariant_evaluator.set_lt(&constraint, solution),
            "set_lt_reif" => self
                .set_invariant_evaluator
                .set_lt_reif(&constraint, solution),
            "set_ne" => self.set_invariant_evaluator.set_ne(&constraint, solution),
            "set_ne_reif" => self
                .set_invariant_evaluator
                .set_ne_reif(&constraint, solution),
            "set_subset" => self
                .set_invariant_evaluator
                .set_subset(&constraint, solution),
            "set_subset_reif" => self
                .set_invariant_evaluator
                .set_subset_reif(&constraint, solution),
            "set_superset" => self
                .set_invariant_evaluator
                .set_superset(&constraint, solution),
            "set_superset_reif" => self
                .set_invariant_evaluator
                .set_superset_reif(&constraint, solution),
            "set_symmetric_difference" => self
                .set_invariant_evaluator
                .set_symdiff(&constraint, solution),
            "set_symdiff" => self
                .set_invariant_evaluator
                .set_symdiff(&constraint, solution),
            "set_union" => self
                .set_invariant_evaluator
                .set_union(&constraint, solution),
            other => panic!("Missing set predicate: {}", other),
        }
    }
