...
impl SetInvariantEvaluator {
    ...
    pub fn array_set_element(
        ...
        let array_value = self.args_extractor.extract_set_array_element(
            ARRAY_INDEX,
            &constraint.call,
            &self.arrays,
            solution,
    ...
    pub fn set_diff(
        ...
        let y = self
            .args_extractor
            .extract_set_value(Y_TERM_INDEX, &constraint.call, solution);
        let z = self
            .args_extractor
            .extract_set_value(Z_TERM_INDEX, &constraint.call, solution);
    ...
    pub fn set_in(
        ...
        let elem =
            self.args_extractor
                .extract_set_element(X_TERM_INDEX, &constraint.call, solution);
        let y = self
            .args_extractor
            .extract_set_value(Y_TERM_INDEX, &constraint.call, solution);
