...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let eval_fn = |solution: &[f64]| {
        ...
        let constraints = [
            -127.0 + 2.0 * x1.powf(2.0) + 3.0 * x2.powf(4.0) + x3 + 4.0 * x4.powf(2.0) + 5.0 * x5,
            -282.0 + 7.0 * x1 + 3.0 * x2 + 10.0 * x3.powf(2.0) + x4 - x5,
            -196.0 + 23.0 * x1 + x2.powf(2.0) + 6.0 * x6.powf(2.0) - 8.0 * x7,
            4.0 * x1.powf(2.0) + x2.powf(2.0) - 3.0 * x1 * x2 + 2.0 * x3.powf(2.0) + 5.0 * x6 - 11.0 * x7,
        ];
        ...
        let objective =
            (x1 - 10.0).powf(2.0)
            + 5.0 * (x2 - 12.0).powf(2.0)
            + x3.powf(4.0)
            + 3.0 * (x4 - 11.0).powf(2.0)
            + 10.0 * x5.powf(6.0)
            + 7.0 * x6.powf(2.0)
            + x7.powf(4.0)
            - 4.0 * x6 * x7
    ...
    // best known objective for g09 (placeholder — set real value if available)
    let best_known_obj = 680.630057374402;
